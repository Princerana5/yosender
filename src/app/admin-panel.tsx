          ...
          {showAddRental && (
            <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input value={newRental.session} onChange={e=>setNewRental({...newRental, session:e.target.value})} placeholder="Telegram session string (optional — mock if empty)" className="border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm outline-none focus:border-[#229ED9] md:col-span-2" />
