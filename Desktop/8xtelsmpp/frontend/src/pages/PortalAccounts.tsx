...
export default function PortalAccounts(): JSX.Element {
  ...
  const [form, setForm] = useState({
    ...
    showPw: false, currency: 'EUR', credit_limit: '0', tps_limit: '50',
  });
          ...
          <form onSubmit={create} className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <div className="rounded-lg border border-brand/50 bg-brand/10 px-3 py-2 text-xs font-semibold text-emerald-300">
